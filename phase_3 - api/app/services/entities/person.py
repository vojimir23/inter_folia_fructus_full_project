...
from app.services.common import extract_human_readable_id, calculate_richness, parse_year_input
...
def process_persons(raw_persons: List[Dict[str, Any]], context: Dict[str, Any]) -> Tuple[List[Dict[str, Any]], Dict[str, Any]]:
    ...
    for person in raw_persons:
        ...
        birth_year = parse_year_input(birth_date_str, is_start_of_range=True)
        death_year = parse_year_input(death_date_str, is_start_of_range=False)
