...
def process_visual_objects(
    ...
    for vo in raw_vos:
        ...
        transcription_stripped = strip_diacritics(transcription)
        transcription_normalized = apply_confusables(transcription_stripped.lower())
        transcription_normalized_cs = apply_confusables(transcription_stripped)
